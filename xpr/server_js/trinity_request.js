...
exports.process = function(context, options) {
    ...
    switch (jsonData.action) {
        ...
        case "create_chat_completions":
            return trinity.create_chat_completions(jsonData.data, customer_id, request.headers.Auth);
        break;
        // get chat messages
        case "get_chat_messages":   
            return trinity.get_chat_messages(jsonData.chat_id, jsonData.params);
    }
