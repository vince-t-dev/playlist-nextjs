...
exports.process = function (context, options) {
    ...
    switch (jsonData.action) {
        ...
        case "getPlaylists":
            ...
            // fetch boson template for each playlist and attach as _template
            _.each(playlists, function (playlist) {
                if (playlist.RendererBundlePath) {
                    try {
                        let boson = api({
                            uri: "/bundles/entities/Boson/" + playlist.RendererBundlePath,
                            method: "GET"
                        });
                        playlist._template = (boson && typeof boson.Template === "string") ? boson.Template : null;
                    } catch (err) {
                        playlist._template = null;
                    }
                } else {
                    playlist._template = null;
                }
